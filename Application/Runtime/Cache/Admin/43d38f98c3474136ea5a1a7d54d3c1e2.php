...
<div class="ui container">
  ...
  <div class="ui top attached segment">
    ...
    <div class="ui big breadcrumb">
      ...
      <div class="active section">添加账目</div>
    </div>
  </div>
  <form id="cms-form">
      ...
      <div class ="ui two column grid">
        <div class="column">
          <div class="ui labeled input" style="width: 100%;">
            ...
            <input type="text" name="finance_name" placeholder="">
          </div>
        </div>
      ...
      <div class ="ui two column grid">
        ...
        <div class="column">
          <div class="ui labeled input" style="width: 100%;">
            ...
            <input type="text" name="entry_people" placeholder="">
          </div>
        </div>
      </div>
      ...
      <div class ="ui grid">
        <div class="four wide column">
          <div class="ui labeled input" style="width: 100%;">
            ...
            <input type="text" name="begin_time" placeholder="">
        ...
        <div class="four wide column">
          <div class="ui labeled input" style="width: 100%;">
            ...
            <input type="text" name="over_time" placeholder="">
...
<!--             <th>单量</th> -->
          ...
          <tbody>
            <?php if(is_array($members)): $k = 0; $__LIST__ = $members;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$member): $mod = ($k % 2 );++$k;?><tr>
                ...
                <td><input type="text" name="<?php echo ($member["memberid"]); ?>" placeholder=""></td>
<!--                <td><input type="text" name="<?php echo ($member["id"]); ?>" placeholder=""></td> -->
