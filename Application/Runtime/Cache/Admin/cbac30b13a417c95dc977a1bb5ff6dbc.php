...
<div class="ui container">
  ...
  <div class="ui top attached segment">
    ...
    <div class="ui big breadcrumb">
      ...
      <div class="active section">添加会员</div>
    </div>
  </div>
<form id="cms-form">
    ...
    <div class ="ui two column grid">
      ...
      <div class="column">
        <div class="ui labeled input" style="width: 100%;">
          ...
          <input type="text" name="paynumber" placeholder="">
        </div>
      </div>
    </div>
    ...
    <div class ="ui two column grid">
      ...
      <div class="column">
        <div class="ui labeled input" style="width: 100%;">
          ...
          <input type="text" name="jointime" placeholder="">
        </div>
      </div>
      </div>
...
<!--       <div class="column">
        <div class="ui card">
          <div class="content">
            <div class="header">郎日天</div>
            <div class="meta">
              <span class="category">男  ID：xxxx</span>
            </div>
